...
import { Check, Link as LinkIcon, Music, PlusCircle, Trash2 } from "lucide-react";
    ...
    <div className="container mx-auto p-4 grid md:grid-cols-2 gap-8">
      <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              ...
              <Select
                ...
                onValueChange={(value: LinkType) =>
                  setNewMainLink((prev) => ({ ...prev, type: value }))
                }
              >
        ...
        <div className="space-y-2">
          ...
          {formData.links.length > 0 && <div className="h-6" />}{" "}
          {/* Add space if there are links */}
          <div className="space-y-2">
            <Input
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4 mb-6">
              {formData.logo && (
                <img src={formData.logo} alt="Logo" className="w-20 h-20 rounded-full shadow-md" />
              )}
              <div>
