            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  PoddyLinks helps you create one link for all your podcast platforms. Boost your
                  audience and simplify sharing.
                </p>
              </div>
          ...
          <div className="px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  Create a single link that directs listeners to your podcast on their preferred
                  platform.
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                ...
                <CardContent>
                  Set up your PoddyLink in minutes with our intuitive dashboard. No technical skills
                  required.
                </CardContent>
              </Card>
            </div>
            ...
            <ol className="grid grid-cols-1 md:grid-cols-3 gap-6 list-decimal list-inside">
              <li className="text-lg font-semibold mb-2">
                ...
                <p className="text-base font-normal text-gray-500 dark:text-gray-400 mt-2">
                  Sign up and generate your unique PoddyLink in just a few clicks.
                </p>
              </li>
              <li className="text-lg font-semibold mb-2">
              ...
              <li className="text-lg font-semibold mb-2">
                Share and Grow
                <p className="text-base font-normal text-gray-500 dark:text-gray-400 mt-2">
                  Use your PoddyLink everywhere to simplify sharing and expand your audience.
                </p>
              </li>
            </ol>
          </div>
          ...
          <div className="px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Join thousands of podcasters using PoddyLinks to grow their audience and
                  streamline their sharing process.
                </p>
              </div>
              <div className="space-x-4">
